...
useEffect(()=>{
  ...
  const renderName = (passengerName) => {
    if (passengerName === 'child') {
      return  <Text style={styles.passengerName}>{t('child')}</Text>;
    } else if (passengerName === 'adult') {
      return <Text style={styles.passengerName}>{t('adult')}</Text>;
    } else if (passengerName === 'baby') {
      return <Text style={styles.passengerName}>{t('baby')}</Text>;
    } else if (passengerName === 'elder') {
    return <Text style={styles.passengerName}>{t('elder')}</Text>;
  }
  }
